    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println(">> Sent Server Message [" + endUserMsg + "] to server[" + SERVER_NAME +"] on port[" + PORT + "] at " + Calendar.getInstance().getTime());;
                ...
                System.out.println("<< Received Server Message [" + inMessage + "] from Server");
            }
