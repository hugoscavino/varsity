        ...
        try {
            ...
            while (true) {
                ...
                if (clientMessage.equalsIgnoreCase(QUIT_COMMAND)){
                    System.out.println("!! Server QUITTING: Received [" + QUIT_COMMAND + "] Command");
                    break;
                }

                System.out.println("<< Server Received Client Message: [" + clientMessage + "]");
                Scanner scanner = new Scanner(System.in);

                System.out.println("Enter a Reply to the Client's Message");

                final String reply = scanner.nextLine();
                // Get the Reply from the user
                out.println(reply);
                out.flush();
                System.out.println(">> Server Sent Message: [" + reply + "] to Client at " + Calendar.getInstance().getTime());
